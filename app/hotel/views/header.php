            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown ">
                            <a href="reservation_1.html" title="Reservation" class="dropdown-toggle" data-toggle="dropdown">Quản Lí Phòng<b class="caret"></b></a>
                            <ul class="dropdown-menu icon-fa-caret-up submenu-hover">
                                <li><a href="index.php?act=show_phong" title="">Danh Sách </a></li>
                                <li><a href="index.php?act=add_phong" title="">Thêm Phòng</a></li>
                            </ul>
                        </li>
                        <li class="dropdown ">
                            <a href="reservation_1.html" title="Reservation" class="dropdown-toggle" data-toggle="dropdown">Quản Lí Loại Phòng<b class="caret"></b></a>
                            <ul class="dropdown-menu icon-fa-caret-up submenu-hover">
                                <li><a href="index.php?act=show_loai_phong" title="">Danh Sách </a></li>
                                <li><a href="index.php?act=add_loai_phong" title="">Thêm Loại Phòng</a></li>
                            </ul>
                        </li>
                        <li class="dropdown ">
                            <a href="reservation_1.html" title="Reservation" class="dropdown-toggle" data-toggle="dropdown">Quản Lí Bình Luận<b class="caret"></b></a>
                            <ul class="dropdown-menu icon-fa-caret-up submenu-hover">
                                <li><a href="index.php?act=show_binh_luan" title="">Danh Sách </a></li>
                            </ul>
                        </li>
                        <li class="">
                        ...
                        <li class="dropdown ">
                            <a href="reservation_1.html" title="Reservation" class="dropdown-toggle" data-toggle="dropdown">Quản Lí Tài Khoản<b class="caret"></b></a>
                            <ul class="dropdown-menu icon-fa-caret-up submenu-hover">
                                <li><a href="index.php?act=show_tai_khoan" title="">Danh Sách </a></li>
                                <li><a href="index.php?act=add_tai_khoan" title="">Thêm Loại Phòng</a></li>
                            </ul>
                        </li>
