<?php
function insert_comment($chi_tiet_binh_luan, $id_phong,$id_tai_khoan,$thoi_gian_binh_luan,$trang_thai){
    $sql = "INSERT INTO `binh_luan`(`chi_tiet_binh_luan`, `id_phong`, `id_tai_khoan`, `thoi_gian_binh_luan`, `trang_thai`) VALUES ('$chi_tiet_binh_luan', '$id_phong', '$id_tai_khoan', '$thoi_gian_binh_luan', '$trang_thai');";
    pdo_execute($sql);
}
